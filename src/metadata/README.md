 ...
 * [scao-odk.yaml.yml](scao-odk.yaml.yml)
     * Determines how your purl.obolibrary.org/obo/scao-odk.yaml/ redirects will be handled
     ...
     * Paste in the contents of [scao-odk.yaml.yml](scao-odk.yaml.yml)
 ...
 * [scao-odk.yaml.md](scao-odk.yaml.md)
     ...
     * Paste in the contents of [scao-odk.yaml.md](scao-odk.yaml.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
